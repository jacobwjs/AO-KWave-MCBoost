...
void TMatrixContainer::AddMatricesIntoContainer(){
    ...
    {
       MatrixContainer[refractive_x_sensor].SetAllValues(NULL,TMatrixRecord::mdtReal, SensorDims, false, refractive_x_sensor_Name);
    }
    if (Params->IsStore_refractive_y())
    {
        MatrixContainer[refractive_y_sensor].SetAllValues(NULL,TMatrixRecord::mdtReal, SensorDims, false, refractive_y_sensor_Name);
    }
    if (Params->IsStore_refractive_z())
    {
        MatrixContainer[refractive_z_sensor].SetAllValues(NULL,TMatrixRecord::mdtReal, SensorDims, false, refractive_z_sensor_Name);
    }
